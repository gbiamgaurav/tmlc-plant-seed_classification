...
from plant_seed.utils.common import decodeImage
from plant_seed.pipeline.predictions import PredictionPipeline
...
st.title("Plant Seed Classification App")

page = st.selectbox("Select a page:", ["Home", "Train", "Predict"])

if page == "Home":
    st.header("Home Page")
    st.write("Welcome to the Plant Seed Classification Web App.")
